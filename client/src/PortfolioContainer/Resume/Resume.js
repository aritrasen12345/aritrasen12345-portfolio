...
const Resume = (props) => {
    ...
    const resumeDetails = [
        ...
        <div className="resume-screen-container" key="achievements">
            <ResumeHeading
                heading="5 Star Coder at HackerRank"
            />
            <ResumeHeading
                heading="3 Star Coder at Codechef"
            />
            <ResumeHeading
                heading="Google KickStart Rank 3423(2021)"
            />
            <ResumeHeading
                heading="Hactoberfest 2021"
            />
            <ResumeHeading
                heading="Machine Learning Coursera(2021)"
            />
            <ResumeHeading
                heading="CSFPC CertiProf(2021)"
            />
        </div>,
